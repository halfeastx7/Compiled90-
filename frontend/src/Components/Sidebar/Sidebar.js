...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar-main" style={{ width: collapsed ? '80px' : '200px', transition: 'width 0.3s' }}>
      <div className="logo-sidebar" style={{ padding: collapsed ? '10px' : '20px' }}> {/* Adjust padding for collapsed state */}
        {collapsed ? (
          <span>
            DAPUR<br />MATE
          </span>
      ...
      <div className="sidebar-footer-button" style={{ textAlign: 'center', marginTop: 'auto' }}>
